...
const StatementPrintView: React.FC<StatementPrintViewProps> = ({
  statementData,
  isLoadingDetail,
  detailError,
  schoolName,
            ...
            >
              ...
              >
                <div>
                  ...
                  <span style={{ fontWeight: 600, color: '#f97316' }}>SchoolFoundry</span> - a
                  product of <span style={{ color: '#374151' }}>Jiggabyte Technology Limited</span>
                </div>
