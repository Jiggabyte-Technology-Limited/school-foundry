      ...
      <div className="topbar-right">
        <div className="topbar-user" style={{ cursor: 'default' }}>
          <div className="topbar-user-info" style={{ textAlign: 'right', marginRight: '12px' }}>
            <span className="topbar-user-name text-display" style={{ display: 'block' }}>{userName}</span>
            <span className="topbar-user-role text-mono" style={{ fontSize: '10px', textTransform: 'uppercase', letterSpacing: '0.05em', color: 'var(--primary)', fontWeight: 700 }}>{userRole}</span>
          </div>
