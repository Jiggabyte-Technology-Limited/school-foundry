          ...
          <div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '28px', background: '#f9fafb', padding: '16px', borderRadius: '8px' }}>
              ...
              <div style={{ textAlign: 'right', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '8px' }}>
                ...
                <button className="btn btn-outline" onClick={onEditProfile} style={{ padding: '4px 12px', fontSize: '11px', display: 'flex', alignItems: 'center', gap: '6px' }}>
            ...
            <div style={{ flex: 1, overflow: 'auto' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                ...
                <tbody>
                  {showOwing && statementData.fees.map((item: any, i: any) => (
                  ...
                  {showPaid && statementData.payments.map((item: any, i: any) => (
                  ...
                  {(statementData.fees.length === 0 || !showOwing) && (statementData.payments.length === 0 || !showPaid) && (
        ...
        {statementData && (statementData.fees.length + statementData.payments.length) > 15 && (
          <div style={{ marginTop: '24px' }}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                {showOwing && statementData.fees.slice(10).map((item: any, i: any) => (
                  <tr key={`fee2-${i}`}>
                ...
                {showPaid && statementData.payments.slice(10).map((item: any, i: any) => (
                  <tr key={`pay2-${i}`}>
